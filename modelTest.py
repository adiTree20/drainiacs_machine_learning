...
#define file paths
train_path = 'C:/Users/adity/OneDrive/Documents/GitHub/dog-cat-full-dataset/data/train' #fill in path to training data
...
batch_size = 50 #hyperparameter you can modify!
...
class Network(nn.Module):
    def __init__(self, in_channels, num_classes):
        ...
        num_filters = 64
        self.layer1 = nn.Conv2d(in_channels=3, out_channels=12, kernel_size=3, stride=1, padding=1) #experiment with kernel_size and stride!
        ...
        self.layer2 = nn.Linear(in_features=32*32*24, out_features=num_classes)  #might have to modify dimensions 
